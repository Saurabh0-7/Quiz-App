...
const html = document.querySelector('#Pipes And Cisterns');
const js = document.querySelector('#Problem On Ages');
const python = document.querySelector('#Profit And Loss')
...
function startCssQuiz(){
    //timer starts
    queTimer(timeValue);
    topicName.innerHTML = "Probability";
...
function startJsQuiz(){
    queTimer(timeValue);
    topicName.innerHTML = "Problem On Ages";
    home.classList.add('hide');
    quizPage.classList.remove('hide');
